...
final class SettingsWindowController: NSWindowController, NSWindowDelegate {
    ...
    @objc private func showSetupGuide() {
        ...
        alert.informativeText = "Install ffmpeg with Homebrew, then choose a Python 3 executable containing NumPy. Developers can also set STATELET_ALPHA_PYTHON before launch. Conversion and verification stay entirely on this Mac."
