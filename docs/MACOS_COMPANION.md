...
This reference documents the internal contracts behind Statelet 1.8.13 (build
27), the native Codex and Grok Build lifecycle companion for macOS. Start with
