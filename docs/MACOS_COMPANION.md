...
This reference documents the internal contracts behind Statelet 1.8.22 (build
36), the native Codex and Grok Build lifecycle companion for macOS. Start with
