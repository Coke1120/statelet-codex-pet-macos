...
This reference documents the internal contracts behind Statelet 1.8.14 (build
28), the native Codex and Grok Build lifecycle companion for macOS. Start with
