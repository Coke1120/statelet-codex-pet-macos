...
This reference documents the internal contracts behind Statelet 1.8.19 (build
33), the native Codex and Grok Build lifecycle companion for macOS. Start with
