...
This reference documents the internal contracts behind Statelet 1.9.0 (build
38), the native Codex and Grok Build lifecycle companion for macOS. Start with
